...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // El resto del script para cancelar clases...
        document.querySelectorAll(".form-cancelar").forEach(form => {
            form.addEventListener("submit", function(e) { /* ...código existente... */ });
        });
        if (params.get("cancel") === "ok") { /* ...código existente... */ }
        if (params.get("cancel") === "error") { /* ...código existente... */ }
    });
</script>
</body>
</html>