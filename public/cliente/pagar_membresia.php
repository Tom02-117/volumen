...
// --- LÓGICA INTELIGENTE PARA IDENTIFICAR QUÉ SE ESTÁ COMPRANDO ---
$item_type = $_GET['item_type'] ?? null;

// Definimos variables que llenaremos según el caso
$titulo_compra = '';
$descripcion_compra = '';
$precio_compra = 0.00;
$id_membresia_compra = 0; // Solo para membresías
$clase_info = []; // Solo para clases

if ($item_type === 'clase') {
    // ESCENARIO A: Se está pagando una clase individual
    $clase_info = [
    ...
    $precio_compra = 5.00; // Precio fijo para la clase

} else {
    // ESCENARIO B: Se está comprando una membresía (el flujo por defecto)
    $item_type = 'membresia'; // Aseguramos el tipo
